    ...
    $(document).ready(function() {
        ...
        $(".add-row").click(function(e) {
            ...
            if (type != '' && name != '') {
                ...
                var markup = "<tr><td><input type='checkbox' name='record'></td><td><input type='text' value='" + type +
                    "'  id='type' name='type[]' style='border:unset;'></td><td><input type='text' value='" + name +
                    "'  id='name' name='name[]' style='border:unset;'></td> </td><td><input type='text' value='" + res +
                    "'  id='fields' name='fields[]' style='border:unset;'></td></tr>";
