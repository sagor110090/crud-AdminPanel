...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Edit test #{{ $test->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/test/' . $test->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
